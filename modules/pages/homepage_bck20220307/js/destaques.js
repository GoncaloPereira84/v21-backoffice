...
window.addEventListener("load", function (e) {
  ...
  $('#destaque-text-pt').summernote({
    ...
    callbacks: {
      ...
      onKeyup: function (e) {
        var t = e.currentTarget.innerText;
        $('.destaque-text-pt span').text(350 - t.trim().length);
      },
      onPaste: function (e) {
        var t = e.currentTarget.innerText;
        ...
        $('.destaque-text-pt span').text(350 - t.length);
      }
    }
  });
  ...
  $('#destaque-text-en').summernote({
    ...
    callbacks: {
      ...
      onKeyup: function (e) {
        var t = e.currentTarget.innerText;
        $('.destaque-text-en span').text(350 - t.trim().length);
      },
      onPaste: function (e) {
        var t = e.currentTarget.innerText;
        var bufferText = ((e.originalEvent || e).clipboardData || window.clipboardData).getData('Text');
        ...
        $('.destaque-text-en span').text(350 - t.length);
      }
    }
  });
});
...
function selectDestaque(id) {
  ...
  if (linhaDestaque.classList.contains("active")) {
    ...
    $('.destaque-text-pt span').text('350');
    $('.destaque-text-en span').text('350');
...
function getAllDataByDestaque(destaque) {
  ...
  $('.destaque-text-pt span').text(350 - destaque[0].text.replace(/(<([^>]+)>)/ig, "").length);
  $('.destaque-text-en span').text(350 - destaque[0].text_en.replace(/(<([^>]+)>)/ig, "").length);
...
$updateDestaqueBtn.click(function () {
  ...
  if (
    ...
    dataDestaque.textPT.replace(/(<([^>]+)>)/ig, '').length < 351 &&
    dataDestaque.textEN.replace(/(<([^>]+)>)/ig, '').length < 351
  ) {
