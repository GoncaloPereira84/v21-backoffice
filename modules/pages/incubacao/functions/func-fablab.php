...
function updateFablab()
{
    ...
    if (isset($_FILES['file'])) {
        $errors = [];
        $path = $_SERVER['DOCUMENT_ROOT']. '/uploads/inc-fablab/'; //to BO path
        // $path1 = 'https://beta.v21.pt/uploads/inc-fablab/'; //to website path
        $path1 = explode('backoffice.v21.pt', $_SERVER['DOCUMENT_ROOT'])[0] . 'v21.pt/uploads/inc-fablab/'; //to website path
        ...
        if (empty($errors)) {
            ...
            if ($file) {
                $sql_update = "UPDATE inc_fablab
                    SET title = '" . $titlePT . "',
                    title_en = '" . $titleEN . "',
                    text = '" . $textPT . "',
                    text_en = '" . $textEN . "',
                    img_src = 'https://www.v21.pt/uploads/inc-fablab/" . $file_name . "',
                    img_align = '" . $align . "'";
