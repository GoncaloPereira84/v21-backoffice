                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div id="noticia-cont" class="card shadow mb-4">
                                <div class="card-body">
                                        ...
                                        <div class="col-lg-12" style="display: flex;">
                                            <div class="form-group col-lg-6" style="display:flex;flex-direction:column;align-items:flex-start;">
                                                <button id="editPicture" type="button" class="btn btn-success btn-icon-split float-left" data-toggle="modal" data-target="#uploadPhotoModal">
                                                    ...
                                                    <span class="text" style="color: #fff;">Inserir imagem</span>
                                                </button>
                                    ...
                                    <div id="add-galeria-section" class="card shadow mb-4" style="display: none;flex-direction:column;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="deleteGaleriaBtn" class="col-auto">
                                                <a id="deleteGaleriaNoticia" class="deleteFoto btn btn-danger btn-icon-split float-right">
                                                    <span class="icon text-white-50">
                                    ...
                                    <div class="row" style="justify-content: flex-end;">
                                        <div id="addGaleriaBtn" class="col-auto">
