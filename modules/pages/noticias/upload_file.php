...
if (isset($_FILES['filepond_pdf'])) {
    ...
    $path1 = explode('beta-bo.v21.pt',$_SERVER['DOCUMENT_ROOT'])[0] . 'v21.pt/uploads/biblioteca-multimedia/'; //to website path
    $extensions = ['pdf', 'PDF'];
        ...
        if ($file) {
            ...
            if(!empty($imagem)){
                ...
                if ($result = $connection->query($sql_insert)) {
                    ...
                    // echo "true||https://v21.pt/uploads/biblioteca-multimedia/" . $file_name;
