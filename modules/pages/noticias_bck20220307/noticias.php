                                ...
                                <div class="card-body">
                                    ...
                                    <div id="noticiaInfo" class="row" style="display: none;">
                                        ...
                                        <div class="col-lg-12" style="display: flex;">
                                            <div class="form-group col-lg-3">
                                                ...
                                                <input id="noticia-img" class="form-control" name="files" type="file">
                                        ...
                                        <div class="col-lg-12" style="display: flex;">
                                            <div class="form-group col-lg-6">
                                                <label for="uploaded-pdf">PDF existente:</label>
                                                <span id="uploaded-pdf"><a href="" target="_blank"></a></span>
                                            </div>
                                            <div class="form-group col-lg-6">
                                    ...
                                    <div id="galeria-section" class="card shadow mb-4" style="display: none;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="imagens" class="row" style="max-height: 400px; overflow: auto;">
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <h4 style="margin-top: 30px;">Adicionar/editar imagem</h4>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="fotos-container">
                                                <div class="foto-1 foto">
                                                    <div class="col-lg-12" style="display: flex;">
                                                        <div class="form-group col-lg-3">
                                                            <label for="titulo-pt-img-galeria">Título:</label>
                                                            <input class="titulo-pt-img-galeria form-control" type="text">
                                                            <span class="titulo-pt-img-galeria-erro erro"></span>
                                                        </div>
                                                        <div class="form-group col-lg-4">
                                                            <label for="noticia-img-galeria">Imagem:</label>
                                                            <input class="noticia-img-galeria form-control" name="files_gallery[]" type="file">
                                                            <span>Tamanho máximo da imagem: 400KB.</span>
                                                            <span>Formatos aceites: png, jpg.</span>
                                                        </div>
