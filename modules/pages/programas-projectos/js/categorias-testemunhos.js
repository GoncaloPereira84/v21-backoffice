...
window.addEventListener("load", function (e) {
  ...
  function getCategorias(last, idCategoria) {
    ...
    xhttp.open(
      "GET",
      "functions/func-categorias-testemunhos.php?cmdEval=getCategorias"
    );
    xhttp.send();
  ...
  function getCategoriaById(idCategoria) {
    ...
    xhttp.open(
      "GET",
      "functions/func-categorias-testemunhos.php?cmdEval=getAllCategoriasByIdCategoria&id_categoria=" +
      idCategoria
    );
    xhttp.send();
  }
  ...
  $updateAreasEspecializacaoBtn.click(function () {
    ...
    if (dataCategoria.titlePT != "") {
      ...
      xhttp.open("POST", "functions/func-categorias-testemunhos.php", true);
...
$deleteCatBtn.click(function (id) {
    ...
    xhttp.open("GET", "functions/func-categorias-testemunhos.php?cmdEval=deleteCategoria&id=" + id);
    xhttp.send();
});
