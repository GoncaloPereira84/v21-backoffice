...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="flex-direction: column; align-items: flex-start !important;">
                        <h1 class="h1 mb-0 text-gray-800">Startup School</h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div id="slideshow" class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div id="startupSchoolInfo" class="row">
                                        <div class="col-lg-12" style="display: flex;">
                                            <div class="form-group col-lg-6">
                                                <label for="titulo-pt">Título 1:</label>
                                        ...
                                        <div class="col-lg-12" style="display: flex;">
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div id="text-pt"></div>
                                                <span class="characters text-pt">caracteres: <span>750</span></span>
                                                <span class="text-pt erro"></span>
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="text-en">Tradução:</label>
                                                <div id="text-en"></div>
                                                <span class="characters text-en">caracteres: <span>750</span></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" style="display: flex; flex-wrap: wrap;">
                                            <div class="form-group col-lg-3" style="display: flex; flex-direction: column;">
                                                <label for="ss-img-actual">Imagem:</label>
                                                <img style="width: 80%;" id="ss-img-actual" src="">
                                            </div>
                                            <div class="form-group col-lg-3">
                                                <label for="ss-img-actual-alinhamento">Alinhamento da imagem:</label>
                                                <input id="ss-img-actual-alinhamento" class="form-control" type="text" disabled>
                                            </div>
                                            <div class="form-group col-lg-12"></div>
                                            <div class="form-group col-lg-6">
                                                <label for="ss-img">Inserir imagem:</label>
                                                <input id="ss-img" class="form-control" name="files" type="file">
                                    ...
                                    <div class="row" style="justify-content: flex-end;">
                                        <div class="col-auto">
                                            <a id="updateStartupSchool" class="btn btn-success btn-icon-split float-right">
    ...
    ?>
    <script src="js/startup-school.js"></script>
